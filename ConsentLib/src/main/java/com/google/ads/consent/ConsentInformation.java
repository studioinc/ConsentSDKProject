...
/**
 * Utility methods for collecting consentManager from users.
 */
public class ConsentInformation {
    ...
    /**
     * Describes a consentManager update server response.
     */
    @VisibleForTesting
    ...
    private static class ConsentInfoUpdateTask extends
        ...
        private static final String UPDATE_SUCCESS = "ConsentManager update successful.";
        ...
        private ConsentInfoUpdateResponse makeConsentLookupRequest(String urlString) {
            ...
            try {
                ...
                Log.d("ConsentResponse",urlString);
